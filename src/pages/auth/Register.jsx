      ...
      <section className="register__screen mt-16">
        <div className="container mx-auto px-4 sm:px-0 h-full">
          <div className="flex items-center h-full">
            <div className="left__container w-1/2 flex items-center justify-center h-[500px]">
              <img
                src="/Register.svg"
                alt="register here"
            ...
            <div className="right__container w-1/2">
              <h1 className="font-Karla font-bold text-3xl">Register here</h1>
              <p className="text-sm mt-3 leading-6  pr-24">
                "Welcome to{" "}
